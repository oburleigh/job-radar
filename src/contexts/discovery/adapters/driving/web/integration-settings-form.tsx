...
import { saveIntegrationSettingsAction } from "./integration-settings-actions";
...
export function IntegrationSettingsForm({
  ...
  const [state, action, pending] = useActionState(saveIntegrationSettingsAction, initialState);

  return (
    <form action={action} className="profile-form" key={integration.atsType}>
