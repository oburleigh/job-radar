...
import type { ProfileActionState } from "./save-profile-action";
...
export function ProfileForm({ profile, saveProfile }: ProfileFormProps) {
          ...
          <label>
            ...
            <div className="input-suffix">
              <input
                ...
                min="1"
                max="365"
                defaultValue={profile?.maxAgeDays ?? 30}
              />
              <span>days</span>
            </div>
          </label>
          <label>
            ...
            <div className="input-suffix">
              <input
                ...
                min="0"
                max="100"
                defaultValue={profile?.minScore ?? 70}
              />
              <span>/ 100</span>
            </div>
          </label>
