...
import { formatAnnualSalary } from "@/contexts/discovery/presentation/web/formatters/annual-salary";
import { formatMatchReason } from "@/contexts/discovery/presentation/web/formatters/match-reason";
    ...
    <article className="job-card">
      ...
      <dl className="job-metadata">
        ...
        <div>
          ...
          <dd>{job.salary ? `${formatAnnualSalary(job.salary)} / year` : "Not specified"}</dd>
        </div>
      </dl>
      ...
      <div className="match-footer">
        ...
        <div>
          ...
          <p>{job.reasons.slice(0, 2).map(formatMatchReason).join(" · ")}</p>
        </div>
      </div>
