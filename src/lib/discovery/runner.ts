...
import { getJobRadarConfig, supportsBoardSync } from "@/config/job-radar";
import {
  companyBoards,
  discoveryHits,
  discoveryQueries,
...
import { buildBoardDiscoveryQueries, buildQueries } from "./queries";
...
import type { AtsType, BoardIdentity, SearchHit, SearchProvider } from "./types";
import { isBuiltInAtsType } from "./types";
