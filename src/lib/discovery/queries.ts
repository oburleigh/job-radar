...
const WORLDWIDE_REMOTE_TERMS = ["remote", "work from anywhere", "anywhere in the world"];

export function buildQueries(
  profile: Pick<MatchProfile, "titleTerms" | "locationTerms" | "includeRemote">,
  sources: readonly QuerySource[],
  titleSearchMode: "title" | "anywhere" = "title",
): DiscoveryQuery[] {
  ...
  const remoteClause = orClause(WORLDWIDE_REMOTE_TERMS);
