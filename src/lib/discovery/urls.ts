...
import { getAtsIntegration, getJobRadarConfig, hostMatches } from "@/config/job-radar";

import { isBuiltInAtsType, type AtsType, type BoardIdentity, type ClassifiedUrl } from "./types";
