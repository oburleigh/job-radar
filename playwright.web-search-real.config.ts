...
import { missingRealWebSearchApiKeyReason, realWebSearchApiKey } from "./e2e/real-web-search-key";
...
const braveSearchApiKey = realWebSearchApiKey();

if (!braveSearchApiKey) {
  console.warn(missingRealWebSearchApiKeyReason);
}
